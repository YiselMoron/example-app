<div class="overflow-x-auto">
        <div class="min-w-screen min-h-screen bg-gray-100 flex items-center justify-center bg-gray-100 font-sans overflow-hidden">
            <div class="w-full lg:w-5/6">
                ...
                <div class="inline-block mr-2 mt-2">
                   <button type="button" onclick="document.getElementById('modal-delete').showModal();" class="focus:outline-none text-white text-sm py-2.5 px-5 rounded-md bg-blue-500 hover:bg-blue-600 hover:shadow-lg">Añadir</button>
                </div>
  ...
  <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
    ...
    <div class="">
      <label class="block text-sm text-gray-00" for="cus_name">Project</label>
      <input wire:model="vari" class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="cus_name" name="cus_name" type="text" required="" aria-label="Name">
    </div>
    <div class="mt-2">
      <label class="block text-sm text-gray-600" for="cus_email">Email</label>
      <input  class="w-full px-5  py-4 text-gray-700 bg-gray-200 rounded" id="cus_email" name="cus_email" type="text" required="" placeholder="{{ $vari }}" aria-label="Email">
    </div>
    <div class="mt-2">
...
@can('update')
    <div class="mt-4">
      <button wire:click=" alerta " class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" type="submit">Aceptar</button>
    </div>
@endcan
