    ...
    <div class="pt-3">
        <div class="flex flex-col flex-1 h-full overflow-hidden">
            ...
            <main class="flex-1 max-h-full p-5 overflow-hidden ">
                ...
                <dialog id="modal-create-rol" class=" w-11/12 md:w-6/12 p-5 bg-transparent rounded-md mt-0">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="transition-all hover:bg-gray-100 hover:shadow-lg text-center">
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-center whitespace-nowrap">
                                    <a wire:click="detalle_pedido({{ $item->id }})" class="text-indigo-600 hover:text-indigo-900">Detalles</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
